...
public class ScanFrequencyDialog extends DialogFragment {
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
		...
		final SharedPreferences sharedPreferences = parentActivity.getSharedPreferences("com.jams.music.player",
		 ...
		 * 
		 * 0: Scan at every startup. 1: Scan at every 3 startups. 2: Scan at
		 * every 5 startups. 3: Scan at every 10 startups. 4: Scan at every 20
		 * startups. 5: Scan Manually.
		 *************************************************************************************************/

		// Set the dialog title.
		builder.setTitle(R.string.scan_frequency_instructions);
