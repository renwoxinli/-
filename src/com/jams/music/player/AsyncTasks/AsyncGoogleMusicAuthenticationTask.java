...
public class AsyncGoogleMusicAuthenticationTask extends AsyncTask<String, String, String> {
	...
	public AsyncGoogleMusicAuthenticationTask(Context context, FragmentActivity activity, boolean firstRun,
			String accountName) {
		mContext = context;
		mActivity = activity;
	...
	public AsyncGoogleMusicAuthenticationTask(Context context, SettingsActivity____ activity, boolean firstRun,
			String accountName) {
		mContext = context;
		mActivity = activity;
		mAccountName = accountName;
	...
	protected String doInBackground(String... params) {
		...
		// boolean loginResult = mApp.getGMusicClientCalls().login(mContext,
		// authToken);
		//
		// if (loginResult==true) {
	...
	protected void onPostExecute(String result) {
		...
		// Dialog d =
		// GooglePlayServicesUtil.getErrorDialog(availabilityExceptionStatusCode,
		// mActivity,
		...
		// }
		//
		// } else if (result.equals("GOOGLE_AUTH_EXCEPTION") ||
		// result.equals("GENERIC_EXCEPTION")) {
		// Toast.makeText(mContext, R.string.unknown_error_google_music,
		// Toast.LENGTH_LONG).show();
		// } else if (result.equals("AUTHENTICATED")) {
		// if (mFirstRun) {
		// String text =
		// mContext.getResources().getString(R.string.signed_in_as) + " " +
		// mAccountName;
		...
		// Toast.makeText(mContext, text, Toast.LENGTH_SHORT).show();
		//
		// //Seting the "REBUILD_LIBRARY" flag to true will force MainActivity
		// to rescan the folders.
		// mApp.getSharedPreferences().edit().putBoolean("REBUILD_LIBRARY",
		// true).commit();
		//
		// //Restart the app.
		// final Intent i =
		// mActivity.getBaseContext().getPackageManager().getLaunchIntentForPackage(mActivity.getBaseContext().getPackageName());
		//
		// i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
		// mActivity.finish();
		// mActivity.startActivity(i);
		// }
		// mApp.getSharedPreferences().edit().putBoolean("GOOGLE_PLAY_MUSIC_ENABLED",
		// true).commit();
		// } else {
		// Toast.makeText(mContext, R.string.unknown_error_google_music,
		// Toast.LENGTH_LONG).show();
